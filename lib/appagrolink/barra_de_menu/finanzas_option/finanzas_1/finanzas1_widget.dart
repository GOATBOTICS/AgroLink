...
import 'finanzas1_model.dart';
export 'finanzas1_model.dart';

class Finanzas1Widget extends StatefulWidget {
  const Finanzas1Widget({super.key});

  @override
  State<Finanzas1Widget> createState() => _Finanzas1WidgetState();
}

class _Finanzas1WidgetState extends State<Finanzas1Widget> {
  late Finanzas1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Finanzas1Model());
